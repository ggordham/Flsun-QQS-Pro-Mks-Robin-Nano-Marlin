...
/**
 *  Marlin Configuration file created for FLSUN QQ-S PRO with 
 *  MK Robin Nano v3 board using TS35 Touch screen, TMC2209 uart,
 *  and Robin WIFI
 *
 *  Version 2.0.9.2 of Marlin
 *  Created 2022-01-01
 *
 *  Created using Marlin example configuration file from:
 *  https://github.com/MarlinFirmware/Configurations/tags
 *  under: Configurations/config/examples/delta/FLSUN/
 *
 *  Adjusted for Robin Nano board using config files from:
